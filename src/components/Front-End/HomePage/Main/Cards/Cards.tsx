...
const Cards = ({mode}:Props) => {
  ...
  return (
    <div className={`bg-gray-200 pt-20 relative ${mode==='light'?'bg-gray-200':'bg-gray-900 text-white'}`}>
...
<button
      ...
      type="button">
      <ArrowForwardIosIcon/>المزيد من القاعات 
    </button>
    <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-col-1 gap-4 '>

      <div className={`relative flex flex-col mt-6 text-gray-900 bg-gray-300 shadow-md bg-clip-border rounded-xl w-96 ${mode==='light'?'':'bg-gray-600 text-white'}`}>
  <div
    className="relative h-56 mx-4 -mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl bg-gray-500 shadow-blue-gray-500/40">
    <img
      src={card1}
      alt="card-image" />
  </div>
...
<div className={`relative flex flex-col mt-6 text-gray-900 bg-gray-300 shadow-md bg-clip-border rounded-xl w-96 ${mode==='light'?'':'bg-gray-600 text-white'}`}>
  <div
    className="relative h-56 mx-4 -mt-6 overflow-hidden bg-gray-200 shadow-lg bg-clip-border rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
    <img
      src={card2}
      alt="card-image" />
  </div>
